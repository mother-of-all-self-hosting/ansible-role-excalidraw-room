...
See the project's [documentation](https://github.com/excalidraw/excalidraw-room/blob/master/README.md) to learn what Excalidraw collaboration server does and why it might be useful to you.
